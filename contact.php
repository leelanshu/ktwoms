...
<head>
    ...
    <title>K2M Securities Pvt. Ltd Stocks LLP || Contact Us</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="contact-info-item">
                        ...
                        <a href="#">Office 124, 1st Floor, D Mall, Sec-1O, Rohini, Delhi-110085</a>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="contact-info-item">
                        ...
                        <ul>
                            <li>
                                <a href="tel:011-49789478">011-49789478</a>
                            </li>
                            <li>
                                <a href="tel:9899036028">+91 9899036028</a>
                            </li>
                            <li>
                                <a href="tel:9891232437">9891232437</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-6 offset-sm-3 offset-lg-0 col-lg-4">
                    <div class="contact-info-item">
                        ...
                        <ul>
                            <li>
                                <a href="mailto:Info@k2mstocks.com"><span class="">Info@k2mstocks.com
                                    </span></a>
                            </li>
                            <li>
                                <a href="mailto:k2mstocks@gmaiI.com"><span class="">k2mstocks@gmaiI.com</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="map-area">
        <div class="container-fluid p-0">
            <iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59843174.53779284!2d62.17507173408573!3d23.728204508550373!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3663f18a24cbe857%3A0xa9416bfcd3a0f459!2sAsia!5e0!3m2!1sen!2sbd!4v1601881198928!5m2!1sen!2sbd" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
    </div>
    <!-- End Map -->
